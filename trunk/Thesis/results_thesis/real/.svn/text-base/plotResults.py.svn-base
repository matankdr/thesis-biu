...
for currMap in maps:
	...
	dataFFD = genfromtxt("results_wfd/" + currMap + "/executions/partial_ffd_executions.txt")
	dataWFD = genfromtxt("results_wfd/" + currMap + "/executions/exploration_execution_rafael.txt")
	dataWolfram = genfromtxt("results_wolfram/" + currMap + "/executions/exploration_execution_wolfram.txt")
...
#colors = ['#00ff7f', '#00ffff',	'#66cdaa','#fffacd','#7b68ee']
#colors = ['#ffa500', '#1e90ff',	'#8a2be2','#9acd32','#ff0000']
