We present a novel approach to the problem of frontier
...
\input{ffd_detect_new_frontiers}
...
%	a new frontier which lies within an already scanned area.
    ...
    Because of this, under some specific conditions, points that lie on the synthetic lines
    ...
    To address this potential error, we keep track of sensor visits (sensor covers) of each map cell. % actually, the number of sensor visits
        The
...
\subsection{\FFD is Sound and Complete}
